...
$conn = new mysqli("localhost","omar","omar","tpzoo");
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["ajouter"])) {
    ...
    // Vous devez définir une valeur pour id_Especes, 
    // par exemple, en utilisant une valeur statique ou en la récupérant d'une autre table si cela convient à votre logique d'application.
    $id_Especes = 1; // Exemple de valeur statique
