...
<div class="sidebar">
    <!-- Utilisation d'un lien <a> avec l'attribut href="#" pour déclencher l'appel de la fonction JavaScript -->
...
<div class="content">
    ...
    <!-- Container pour le tableau de bord des animaux -->
    <div id="dashboard-container"></div>

    <script>
        // Fonction pour charger le tableau de bord des animaux sans recharger la page
        function loadDashboardAnimaux() {
            // Récupérer le conteneur pour le tableau de bord
            var dashboardContainer = document.getElementById("dashboard-container");

            // Charger le contenu du tableau de bord des animaux avec AJAX
